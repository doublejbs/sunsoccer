...
export function CommentSection({ articleId, commentCount }: CommentSectionProps) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center py-4 px-4 lg:px-0 border-b border-gray-200">
        <div className="font-semibold text-[15px] text-[#111]">
          댓글 <span className="text-[#111] font-bold">{commentCount}</span>
        </div>
      ...
      <div className="py-4 px-4 lg:px-0 border-b border-gray-200">
          ...
          {hasMore && (
            <div className="py-5 text-center">
              <button onClick={loadMore} disabled={loading}
                className="text-sm text-gray-500 border border-gray-200 px-6 py-2 rounded-lg hover:border-gray-400 transition-colors">
