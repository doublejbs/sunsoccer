    ...
    <div className="bg-white rounded-lg p-4 border border-gray-100">
      ...
      {comments.length === 0 ? (
        ...
        <ul className="space-y-3">
          {comments.map((c) => (
            <li key={c.id} className="pb-3 border-b border-gray-100 last:border-b-0">
              <Link to={`/news/${c.article_id}`} className="block hover:bg-gray-50 -mx-1 px-1 rounded transition-colors">
